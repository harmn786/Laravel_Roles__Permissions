                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('articles.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input type="text" {{ old('title') }} name="title" placeholder="Enter Title" 
                            ...
                            <div class="my-3">
                                <textarea type="text" {{ old('content') }} name="content" placeholder="Enter Description" 
                                class="border-gray-300 shadow-sm w-1/2 rounded-lg" ></textarea>
                            </div>
                            <label for="text-sm font-medium">Author</label>
                            <div class="my-3">
                                <input type="text" {{ old('author') }} name="author" placeholder="Enter Author Name" 
                                class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                                @error('author')
                                <p class="text-red-400 font-medium">{{ $message}}</p>
                                @enderror
